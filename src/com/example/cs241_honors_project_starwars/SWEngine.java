...
public class SWEngine 
{
	...
	public static final int SPLASH_SCREEN_MUSIC = R.raw.golden; // this one
	public static final int R_VOLUME = 100;	// this one
	public static final int L_VOLUME = 100; // this one
	public static final boolean LOOP_BACKGROUND_MUSIC = true; // this one
	public static final int GAME_THREAD_FPS_SLEEP = (1000/60);	
	public static float SCROLL_BACKGROUND_1  = .002f;
	public static float SCROLL_BACKGROUND_2  = .006f;
	public static final int BACKGROUND_LAYER_ONE = R.drawable.space;
	...
	public static int TOTAL_INTERCEPTORS = 20;//10
	public static int TOTAL_SCOUTS = 15;//15
	public static int TOTAL_WARSHIPS = 10;//5
	...
	public static final float PLAYER_BULLET_SPEED = .04f;
	/*Game Variables*/
	...
	public boolean onExit(View v) 
	{
        try
        {
        	Intent bgmusic = new Intent(context, SWMusic.class);
